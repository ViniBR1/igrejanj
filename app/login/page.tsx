...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result?.error) {
      ...
      // Por enquanto, vamos usar o email para identificar
      if (email === 'pastor@nj.com') {
        router.push('/admin');
      } else if (email === 'carlos@nj.com' || email === 'maria@nj.com' || email === 'joao@nj.com') {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 to-purple-800 py-12 px-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <Church className="w-10 h-10 text-purple-600" />
          </div>
